...
Export-ModuleMember -function Connect-MySqlServer
Export-ModuleMember -function Disconnect-MySqlServer
Export-ModuleMember -function Select-MySqlDatabase
Export-ModuleMember -function Get-MySqlDatabase
Export-ModuleMember -function New-MySqlTable
Export-ModuleMember -function Get-MySqlTable
Export-ModuleMember -function Add-MySqlColumn
Export-ModuleMember -function Invoke-MySqlQuery
Export-ModuleMember -function Invoke-MySqlParamQuery